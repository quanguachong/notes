...
ENV TF_SERVING_VERSION $TF_SERVING_VERSION
...
# Install tensorboard,pytorch,kubectl,minio,t9k-pipeline
...
COPY ./pipeline-sdk/gen/python/t9k-pipelines.tar.gz /tmp/t9k-pipelines.tar.gz
RUN pip install /tmp/t9k-pipelines.tar.gz
